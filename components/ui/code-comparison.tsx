...
export default function CodeComparison({
  ...
  const renderCode = (code: string, highlighted: string) => {
    if (highlighted) {
      return (
        <div
          className="h-[20rem] lg:h-[40rem] overflow-auto bg-background font-mono text-xs [&>pre]:h-full [&>pre]:!bg-transparent [&>pre]:p-4 [&_code]:break-all"
  ...
  return (
    <>
      <div className="space-y-8 mx-auto text-center pt-32 pb-10">
